    ...
    <div class="info">
      <div class="stu-info">
        <div class="stu-info-l">
          ...
          <div class="desc">
            <div class="name">{{ resumeItem.name }}</div>
            <div class="major">
              <span>{{ resumeItem.graduateDate }}</span>
              &ensp;|&ensp;
              <span>{{ resumeItem.majorName }}</span>
            </div>
          </div>
        </div>
      ...
      <div class="desc">
        <div class="target">
          求职意向: <span>{{ resumeItem.expJobTips || "暂未填写" }}</span> |
          <span>{{ resumeItem.expCity || "暂未填写" }}</span> |
          <span>{{ resumeItem.expMaxSalary }}</span>元/月
        </div>
